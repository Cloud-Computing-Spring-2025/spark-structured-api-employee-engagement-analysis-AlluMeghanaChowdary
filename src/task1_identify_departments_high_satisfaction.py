...
def main():
    ...
    # Define file paths
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-AlluMeghanaChowdary/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-AlluMeghanaChowdary/outputs/departments_high_satisfaction.csv"
